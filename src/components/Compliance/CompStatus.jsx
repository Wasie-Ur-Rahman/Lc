...
const CompStatus = ({ showmt700, showmt701, showmt707, onComplete }) => {
  ...
  if (showmt700 === null) mt700NA = true;
  if (showmt701 === null) mt701NA = true;
  if (showmt707 === null) mt707NA = true;

  let showmt701NA = false;
  let showmt707NA = false;
  let complete = false;

  if ((mt700NA && mt701NA) || (showmt700 && mt701NA)) {
    showmt701NA = true;
  }
    ...
    <div className="flex self-center w-[80%]  mx-auto">
      <div className="flex flex-col w-[20%]">
        ...
        <div className="flex relative w-[100%]">
          <div
            className="w-9 h-9 rounded-full bg-[#2B333E] flex justify-center items-center"
          ...
          <div
            className="absolute top-4 h-[2px] bg-[#2B333E]"
            style={{
              width: "calc(100% - 36px)",
