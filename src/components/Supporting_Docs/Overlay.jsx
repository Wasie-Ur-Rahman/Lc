...
//     const cleanText = (text) => text.split('.')[0];
...
//                         <path d="M21.1967 22.9175L6.59029 8.74513L8.6961 6.57484L23.3025 20.7472L21.1967 22.9175ZM8.70982 23.2416L6.67733 21.2695L21.2174 6.28418L23.2499 8.25629L8.70982 23.2416Z" fill="#6A6A6A"/>
//                     </svg>
//                 </button>
...
const Overlay = ({ files, onClose, onFileSelect }) => {
    ...
    const cleanText = (text) => text === null ? 'No file selected' : text.split('.')[0];
