...
// const Topnav = ({ activeTab, setActiveTab, handleLogout, userId, setIsAddNewUser }) => {
   
//   console.log("In set active tab" , activeTab)
//   const { token , setActiveFlag  ,     setApiResonseData_Saver  } = useContext(UserContext); 
...
//         <div className='flex'>
//           <img src="/logo lc 1.png" alt="logo" className='h-[104px] w-[94px] mt-1.5 z-50'/>
//           <p className='self-end font-roboto font-semibold text-white'>ComplyTrade</p>
//         </div>
...
//                       onClick={() => { setIsAddNewUser(true); console.log('Add New User Clicked'); }}
//                     >
//                       Add New User
//                     </a>
//                     <a
...
//         <a
//           href='#'
//           className={`font-poppins font-semibold text-[18px] ${activeTab === 'dashboard' ? 'text-[#2B333E] underline underline-offset-8' : 'text-[#6F7884] '}`}
...
//         <a
//           href='#'
//           className={`font-poppins font-semibold text-[18px] ${activeTab === 'compliance' ? 'text-[#2B333E] underline underline-offset-8' : 'text-[#6F7884] '}`}
...
//         <a
//           href='#'
//           className={`font-poppins font-semibold text-[18px] ${activeTab === 'verification' ? 'text-[#2B333E] underline underline-offset-8' : 'text-[#6F7884]'}`}
