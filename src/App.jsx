...
//         <Route
//           path="/"
//           element={!isLoggedIn && <LoginPage setIsLoggedIn={setIsLoggedIn} setUserId={setUserId} setToken={setToken} />}
//         />
//         <Route
//           path="/signup"
//           element={isAddNewUser && (
//             <LoginPage
...
//       {/* Footer */}
//       {isLoggedIn && (
//         <div className='flex w-[100%] absolute bottom-0 h-[25px] gap-1 bg-[#2B333E] justify-end z-100'>
...
//   // Remove route guards and allow navigation to any route
//   useEffect(() => {
//     // Commenting out route guards so the user can navigate freely
//     /*
//     if (isLoggedIn && isAddNewUser) {
//       navigate(`/signup`);
//     } else if (isLoggedIn) {
...
//         <Route
//           path="/"
//           element={<LoginPage setIsLoggedIn={setIsLoggedIn} setUserId={setUserId} setToken={setToken} />}
//         />
//         <Route
//           path="/signup"
//           element={(
...
const App = () => {
  ...
  const {   setActiveFlag , setApiResonseData_Saver , setActiveFlag_1 , setUpload_Results  ,setDocuments_saver  , setFlagsetter  , setPayload_saver  , setFlag_progress , setPayload_carrier , setDocument_verification  , setPayload_setter , setVerifyPage , setStart_again  , setChecking ,  setCount , setMT700 , setApiList , verification , setVerification , api_called ,setApiCalled  , files_saved , setFilesSaved} = useContext(UserContext); 
