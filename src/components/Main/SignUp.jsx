...
//   isCall();
// }, []);
const check = 'https://192.168.18.251:8010/api/user/is_available/';

const registerUser = async (userData) => {
  const url = 'https://192.168.18.251:8010/api/users/user-registeration';
...
const UserRegistrationForm = ({ setIsAddNewUser }) => {
  ...
  return (
    <div className="flex flex-col justify-evenly w-[30%] h-[120%] bg-[#2C333D] opacity-[84%] border-[1px] border-[#242F3A]">
      <form onSubmit={handleSubmit} className="h-[86%] flex flex-col justify-evenly">
        <div className="flex flex-col items-center justify-center">
          <input
            ...
            className={`w-[60%] px-3 py-3 bg-transparent border-[1px] ${
              'border-[#2A8BE9]'
            } font-Inconsolata font-[400] text-[22px] placeholder-white text-white focus:outline-none`}
          />
