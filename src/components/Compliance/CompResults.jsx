...
const [isOpen, setIsOpen] = useState(false);
  ...
  useEffect(() => {
    ...
    console.log("the isMandatoryAndOptionalEmpty is updated :", isMandatoryAndOptionalEmpty );
  ...
  : [0];
    ...
    return (
      ...
      (
        ...
        {isOpen && (
      <div 
      className="absolute -ml-12 top-1 border border-gray-300 rounded-md bg-white shadow-md p-3 w-40 z-50"
    >
      ...
      <ul 
        className="list-none p-0 m-0 text-sm max-h-52 overflow-y-auto"
      >
                    ...
                    <div>
                        ...
                        <div className="flex flex-col w-[100%]">
                            {combinedStatus?.map((status, index) => (
                                <div key={index} className={`comp-result-mt  pl-5 flex   ${verification  ? 'visible' : count === 1 ? 'visible' : visibleDivsMT700 > index && count === 0 ? 'visible' : 'invisible'}
`}>
                        ...
                        <div>
                            ...
                            <div className="flex flex-col gap-[2.5%] w-[100%]">
                                {mt701FieldStatus?.map((status, index) => (
                                    <div key={index} className={`comp-result-mt pl-5 flex ${verification ? 'visible'  :count === 1 ? 'visible' : visibleDivsMT701 > index && count === 0 ? 'visible' : 'invisible'}`}>
                                ...
                                <div >
                                    ...
                                    <div className="flex flex-col w-[100%]">
                                        {data.FieldStatus.map((status, index) => (
                                            <div key={index} className={`flex pl-5 items-center comp-result-mt pt-[2px] ${verification ? 'visible'  : count ===1 ? 'visible' : visibleDivsMT707[index1] > index && count === 0 ? 'visible' : 'invisible'}`}>
                ...
                <div className="absolute top-8 right-16 lg:right-9 w-[30%] border-t border-r Laptops:right-0 h-[94%] border-l-[1px] border-[#959191] flex flex-col">
                    ...
                    <div className=" custom-shadow border flex flex-col overflow-y-auto">
                        {totalFields > 0 && (
                            <div className={` ${verification ? '' : count === 0 ? 'animate-fadeIn' : ''}`}>
                        ...
                        {NoOfMT707Amnds > 0 && (
                            <div className={`relative ${ verification ? '' : count === 0 ? 'animate-fadeIn' : ''}`}>
