...
const CompResStats = ({ type, Errors, totalFields, AmndNo, loaded }) => {
  return (
    <div
      className={`relative bg-white custom-shadow w-[100%] h-[140px] mx-auto`}
    >
      ...
      <div
        className={`w-[100%] h-[105px] rounded-xl grid grid-rows-3 grid-cols-1 gap-y-0 gap-x-0`}
      >
        {/* First Column */}
        <div className="relative flex h-[35px]">
          <div
            className={`w-[100%] border-[##DADADA] border-[1px] flex justify-between items-center`}
          >
            <p
              className={`text-[#2F2F2F] text-[14px] font-Montserrat font-[500] pl-4`}
            >
              Total Fields
            </p>
            <p
              className={`text-[#2F2F2F] text-[14px] font-Montserrat font-[700] pr-4 animate-fadeIn`}
            >
